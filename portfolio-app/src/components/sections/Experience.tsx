...
export function Experience() {
  ...
  return (
    <div ref={containerRef} {...containerHandlers} className="outline-none">
      <div
        ref={trackRef}
      ...
      >
        ...
        {experience.map((e, idx) => {
          ...
          return (
            <Reveal key={e.id} delay={Math.min(idx, 3) * 0.08}>
              <div
                ...
                style={{
                  ...
                  transition:
                    "opacity 0.5s cubic-bezier(0.4,0,0.2,1), filter 0.5s cubic-bezier(0.4,0,0.2,1), transform 0.35s cubic-bezier(0.4,0,0.2,1)",
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    visual.active
                      ? "shadow-[0_0_12px_rgba(91,140,255,0.8)] scale-110"
                ...
                <div>
                  ...
                  <ul className="mt-4.5 flex flex-col gap-3.5 list-none">
                    {e.bullets.map((b, bIdx) => (
                      ...
                      >
                        <span className="text-accent flex-shrink-0 select-none mt-0.5">
                          ▹
                        </span>
                        <span>{t(b)}</span>
                      </li>
